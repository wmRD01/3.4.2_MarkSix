        ...
        (function () {
          !function (r, t) {
            if ("object" == typeof exports && "object" == typeof module) module.exports = t();else if ("function" == typeof define && define.amd) define([], t);else if ("object" == typeof exports) exports.JsCrypto = t();else {
              ...
              for (var e in r.JsCrypto = r.JsCrypto || {}, n) r.JsCrypto[e] = n[e];
            }
          }(this, function () {
            return function () {
              "use strict";
              ...
              for (var a = function () {
                ...
                return Object.defineProperty(r.prototype, "nSigBytes", {
                  ...
                  for (var r = this.i, t = this.u, n = new Uint8Array(t), e = 0; e < t; e++) n[e] = r[e >>> 2] >>> 24 - e % 4 * 8 & 255;
                  ...
                  } else for (e = 0; e < n; e += 4) this.i[this.u + e >>> 2] = t[e >>> 2];
                  ...
                  for (var n = [], e = 0; e < t; e += 4) n.push(a());
              ...
              var h = {
                stringify: function (r) {
                  ...
                  for (var e = [], i = 0; i < n; i += 3) for (var o = (t[i >>> 2] >>> 24 - i % 4 * 8 & 255) << 16 | (t[i + 1 >>> 2] >>> 24 - (i + 1) % 4 * 8 & 255) << 8 | t[i + 2 >>> 2] >>> 24 - (i + 2) % 4 * 8 & 255, a = 0; a < 4 && i + .75 * a < n; a++) e.push(u.charAt(o >>> 6 * (3 - a) & 63));

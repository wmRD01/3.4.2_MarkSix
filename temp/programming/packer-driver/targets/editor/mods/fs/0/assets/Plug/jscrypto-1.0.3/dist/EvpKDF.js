                ...
                3354: function (n, t, r) {
                  ...
                  var i = r(5720),
                    ...
                    return Object.defineProperty(n.prototype, "nSigBytes", {
                      ...
                      for (var n = this.O, t = this._, r = new Uint8Array(t), i = 0; i < t; i++) r[i] = n[i >>> 2] >>> 24 - i % 4 * 8 & 255;
                      ...
                      } else for (i = 0; i < r; i += 4) this.O[this._ + i >>> 2] = t[i >>> 2];
                ...
                7211: function (n, t, r) {
                  ...
                  var i = r(3354),
                    ...
                    return Object.defineProperty(n.prototype, "blockSize", {
                      ...
                      if (f) {
                        for (var a = 0; a < f; a += o) this.u(r, a);
                ...
                var n,
                  ...
                  return u(r, n), r.prototype.compute = function (n, t) {
                    for (var r, i = new this.k(), o = new e.e(), u = o.words, f = this.F, c = this.B; u.length < f;) {
                      ...
                      for (var a = 1; a < c; a++) r = i.finalize(r), i.reset();

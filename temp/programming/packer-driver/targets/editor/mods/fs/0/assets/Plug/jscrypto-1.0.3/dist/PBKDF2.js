              ...
              var n = {
                ...
                5561: function (n, t, r) {
                  ...
                  var h = [],
                    ...
                    return u(t, n), t.prototype.l = function () {
                      ...
                      return n[r >>> 5] |= 128 << 24 - r % 32, n[14 + (r + 64 >>> 9 << 4)] = Math.floor(t / 4294967296), n[15 + (r + 64 >>> 9 << 4)] = t, this.O.nSigBytes = 4 * n.length, this.I(), this.h;
                ...
                3354: function (n, t, r) {
                  ...
                  var i = r(5720),
                      ...
                      o = function () {
                    function n(t, r) {
                      if (Array.isArray(t) || !t) return this.N = Array.isArray(t) ? t : [], void (this.S = "number" == typeof r ? r : 4 * this.N.length);
                      if (t instanceof n) return this.N = t.words.slice(), void (this.S = t.nSigBytes);
                      var i;
                    ...
                    return Object.defineProperty(n.prototype, "nSigBytes", {
                      ...
                      for (var n = this.N, t = this.S, r = new Uint8Array(t), i = 0; i < t; i++) r[i] = n[i >>> 2] >>> 24 - i % 4 * 8 & 255;
                      ...
                      if (this.clamp(), this.S % 4) for (var i = 0; i < r; i++) {
                        ...
                        this.N[this.S + i >>> 2] |= e << 24 - (this.S + i) % 4 * 8;
                      } else for (i = 0; i < r; i += 4) this.N[this.S + i >>> 2] = t[i >>> 2];
                      return this.S += r, this;
                    }, n.prototype.clamp = function () {
                      var n = this.S;
                      this.N[n >>> 2] &= 4294967295 << 32 - n % 4 * 8, this.N.length = Math.ceil(n / 4);
                    }, n.prototype.clone = function () {
                      return new n(this.N.slice(), this.S);
                    }, n.random = function (t) {
                ...
                7211: function (n, t, r) {
                  ...
                  var i = r(3354),
                      ...
                      o = function () {
                    function n(n) {
                      this.F = 0, this.U = 0, this.v = n, this.O = n && void 0 !== n.data ? n.data.clone() : new i.e(), this._ = n && "number" == typeof n.nBytes ? n.nBytes : 0;
                    }
                ...
                1868: function (n, t, r) {
                  ...
                  var i,
                    ...
                    function t(t) {
                      var r = n.call(this, t) || this;
                      return r.U = 16, r.v = t, t && "number" == typeof t.blockSize && (r.U = t.blockSize), r.reset(t ? t.data : void 0, t ? t.nBytes : void 0), r;
                    }
              ...
              return function () {
                ...
                var n,
                  ...
                  function r(r) {
                    ...
                    return i.k = 4, i.T = t.SHA256, i.R = 1e4, r && (i.k = void 0 !== r.keySize ? r.keySize : i.k, i.T = void 0 !== r.Hasher ? r.Hasher : i.T, i.R = void 0 !== r.iterations ? r.iterations : i.R), i;
                  }

                  return f(r, n), r.prototype.compute = function (n, t) {
                    for (var r = new e.Hmac(new this.T(), n), i = new o.e(), u = new o.e([1]), f = i.words, c = u.words, s = this.k, a = this.R; f.length < s;) {
                      var h = r.update(t).finalize(u);
                      r.reset();

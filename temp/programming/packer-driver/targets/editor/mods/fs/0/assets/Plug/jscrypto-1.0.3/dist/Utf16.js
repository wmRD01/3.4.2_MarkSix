            ...
            return function () {
              ...
              var f = function () {
                ...
                stringify: function (n) {
                  for (var r = n.words, t = n.nSigBytes, e = [], i = 0; i < t; i += 2) {
                ...
                parse: function (n) {
                  for (var r = n.length, t = [], e = 0; e < r; e++) t[e >>> 1] |= n.charCodeAt(e) << 16 - e % 2 * 16;
              ...
              var c = {
                ...
                parse: function (n) {
                  for (var r = n.length, t = [], e = 0; e < r; e++) t[e >>> 1] |= s(n.charCodeAt(e) << 16 - e % 2 * 16);

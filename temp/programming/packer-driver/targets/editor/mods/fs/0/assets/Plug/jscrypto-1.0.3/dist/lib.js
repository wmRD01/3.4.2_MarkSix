            ...
            return function () {
                ...
                3354: function (n, t, r) {
                  ...
                  var i = r(5720),
                    ...
                    return Object.defineProperty(n.prototype, "nSigBytes", {
                      ...
                      for (var n = this.N, t = this.B, r = new Uint8Array(t), i = 0; i < t; i++) r[i] = n[i >>> 2] >>> 24 - i % 4 * 8 & 255;
                      ...
                      } else for (i = 0; i < r; i += 4) this.N[this.B + i >>> 2] = t[i >>> 2];
                ...
                6957: function (n, t, r) {
                  ...
                  var i = r(5720),
                    ...
                    return Object.defineProperty(n.prototype, "nSigBytes", {
                      ...
                      for (var t = this.N.slice(), r = 0; r < t.length; r++) t[r] = t[r].clone();
                ...
                7211: function (n, t, r) {
                  ...
                  var i = r(3354),
                    ...
                    return Object.defineProperty(n.prototype, "blockSize", {
                      ...
                      if (f) {
                        for (var a = 0; a < f; a += o) this.l(r, a);
              ...
              return function () {
                ...
                var n = r(9054),
                  ...
                  parse: function (n) {
                    for (var r = n.length, i = [], e = 0; e < r; e++) i[e >>> 1] |= n.charCodeAt(e) << 16 - e % 2 * 16;
                ...
                var v,
                  ...
                  parse: function (n) {
                    for (var r = n.length, i = [], e = 0; e < r; e++) i[e >>> 1] |= h(n.charCodeAt(e) << 16 - e % 2 * 16);
                  ...
                  v(n, t), n.prototype = null === t ? Object.create(t) : (r.prototype = t.prototype, new r());
                }),
                    g = function (n) {
                  function r(t) {
                    var r = n.call(this, t) || this;
                  ...
                  return m(r, n), r.prototype.compute = function (n, r) {
                    for (var i, e = new this.T(), o = new t.e(), u = o.words, f = this.H, c = this.K; u.length < f;) {
                      ...
                      for (var a = 1; a < c; a++) i = e.finalize(i), e.reset();

        ...
        (function () {
          !function (t, n) {
            if ("object" == typeof exports && "object" == typeof module) module.exports = n();else if ("function" == typeof define && define.amd) define([], n);else if ("object" == typeof exports) exports.JsCrypto = n();else {
              ...
              for (var i in t.JsCrypto = t.JsCrypto || {}, t.JsCrypto.mode = t.JsCrypto = t.JsCrypto || {}, t.JsCrypto.mode, e) t.JsCrypto = t.JsCrypto || {}, t.JsCrypto.mode[i] = e[i];
            }
          }(this, function () {
            return function () {
              "use strict";
              ...
              var e,
                ...
                return o(n, t), n.prototype.xorBlock = function (t, n, e) {
                  var i,
                      o = this.h;
                  o ? (i = o.words, this.h = void 0) : i = this.l;

                  for (var r = 0; r < e; r++) t[n + r] ^= i[r];
                  ...
                  return o(n, t), n.prototype.processBlock = function (t, n) {
                    var e = this.u,
                        i = e.blockSize;
                    this.xorBlock(t, n, i), e.encryptBlock(t, n), this.l = t.slice(n, n + i);
                  }, n;
                  ...
                  return o(n, t), n.prototype.processBlock = function (t, n) {
                    var e = this.u,
                        i = e.blockSize,
                        o = t.slice(n, n + i);
                    e.decryptBlock(t, n), this.xorBlock(t, n, i), this.l = o;
                  }, n;
                }(n), n;
              }(i);

        ...
        (function () {
          !function (n, t) {
            if ("object" == typeof exports && "object" == typeof module) module.exports = t();else if ("function" == typeof define && define.amd) define([], t);else if ("object" == typeof exports) exports.JsCrypto = t();else {
              ...
              for (var e in n.JsCrypto = n.JsCrypto || {}, n.JsCrypto.mode = n.JsCrypto = n.JsCrypto || {}, n.JsCrypto.mode, r) n.JsCrypto = n.JsCrypto || {}, n.JsCrypto.mode[e] = r[e];
            }
          }(this, function () {
            return function () {
              "use strict";
              ...
              var f = function () {
                ...
                return Object.defineProperty(n.prototype, "nSigBytes", {
                  ...
                  for (var n = this.v, t = this.l, r = new Uint8Array(t), e = 0; e < t; e++) r[e] = n[e >>> 2] >>> 24 - e % 4 * 8 & 255;
                  ...
                  } else for (e = 0; e < r; e += 4) this.v[this.l + e >>> 2] = t[e >>> 2];
                  ...
                  for (var r = [], e = 0; e < t; e += 4) r.push(f());
              ...
              var c,
                ...
                c(n, t), n.prototype = null === t ? Object.create(t) : (r.prototype = t.prototype, new r());
              }),
                  w = function (n) {
                function t(t) {
                ...
                return h(t, n), t.getB0 = function (n, t, r, e) {
                  ...
                  for (var i = Math.floor(n.nSigBytes / 4), o = 0; o < i; o++) r.concat(new a([n.words[o]], 4));
                  ...
                  for (o = 0; o < u; o++) r.concat(new a([t.words[o]], 4));
                  ...
                  for (var e = new a([(n - 1 & 7) << 24], 1), i = new a([], 0), o = Math.floor(n / 4), u = 0; u < o - 1; u++) i.concat(new a([0], 4));
                  ...
                  for (M = 0; M < 4; M++) I.words[M] ^= O.words[M];
                  ...
                  return h(r, n), r.prototype.processBlock = function (n, r) {
                    ...
                    for (var u = 0; u < i; u++) n[r + u] ^= o.words[u];

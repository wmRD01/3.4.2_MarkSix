          ...
          !function (n, t) {
            ...
            return function () {
              ...
              var e,
                ...
                return r(t, n), t.createEncryptor = function (n) {
                  ...
                  return r(t, n), t.prototype.processBlock = function (n, t) {
                    var e = this.u,
                        o = e.blockSize,
                        r = this.l,
                        i = this.h;
                    r && (i = this.h = r.words.slice(0), this.l = void 0);
                    var u = i.slice(0);
                    e.encryptBlock(u, 0), i[o - 1] = i[o - 1] + 1 | 0;

                    for (var f = 0; f < o; f++) n[t + f] ^= u[f];
                  }, t;

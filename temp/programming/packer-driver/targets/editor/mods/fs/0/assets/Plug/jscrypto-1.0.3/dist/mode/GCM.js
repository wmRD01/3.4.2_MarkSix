        ...
        (function () {
          !function (n, r) {
            if ("object" == typeof exports && "object" == typeof module) module.exports = r();else if ("function" == typeof define && define.amd) define([], r);else if ("object" == typeof exports) exports.JsCrypto = r();else {
              ...
              for (var e in n.JsCrypto = n.JsCrypto || {}, n.JsCrypto.mode = n.JsCrypto = n.JsCrypto || {}, n.JsCrypto.mode, t) n.JsCrypto = n.JsCrypto || {}, n.JsCrypto.mode[e] = t[e];
            }
          }(this, function () {
            return function () {
              "use strict";
              ...
              var f = function () {
                ...
                return Object.defineProperty(n.prototype, "nSigBytes", {
                  ...
                  for (var n = this.v, r = this.l, t = new Uint8Array(r), e = 0; e < r; e++) t[e] = n[e >>> 2] >>> 24 - e % 4 * 8 & 255;
                  ...
                  } else for (e = 0; e < t; e += 4) this.v[this.l + e >>> 2] = r[e >>> 2];
                  ...
                  for (var t = [], e = 0; e < r; e += 4) t.push(f());
              ...
              function s(n) {
                ...
                if (0 !== r) {
                  for (var t = 16 - r, e = [], i = Math.floor(t / 4), o = 0; o < i; o++) e.push(0);
                ...
                return h(r, n), r.getJ0 = function (n, t) {
                  ...
                  if (t && 0 !== t.length) {
                    if (3 === t.length) e = [t[0], t[1], t[2], 1];else {
                      for (var i = t.length % 4 > 0 ? 4 - t.length % 4 : 0, o = t.slice(), u = 0; u < i + 2; u++) o.push(0);
                  ...
                  for (var e = t.length, i = [0, 0, 0, 0], o = 0; o < e; o += 4) i[0] = i[0] ^ t[o], i[1] = i[1] ^ t[o + 1], i[2] = i[2] ^ t[o + 2], i[3] = i[3] ^ t[o + 3], i = r.mul(i, n);
                  ...
                  return h(t, n), t.prototype.processBlock = function (n, t) {
                    ...
                    for (var i = new a(n.slice(t, t + e)), o = r.GCTR(this.u, this.A, i), u = 0; u < e; u++) n[t + u] = o.words[u];
                  }, t;

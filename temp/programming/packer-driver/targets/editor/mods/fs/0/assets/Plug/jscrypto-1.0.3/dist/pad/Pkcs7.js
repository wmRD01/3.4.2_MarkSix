        ...
        (function () {
          !function (n, t) {
            if ("object" == typeof exports && "object" == typeof module) module.exports = t();else if ("function" == typeof define && define.amd) define([], t);else if ("object" == typeof exports) exports.JsCrypto = t();else {
              ...
              for (var e in n.JsCrypto = n.JsCrypto || {}, n.JsCrypto.pad = n.JsCrypto = n.JsCrypto || {}, n.JsCrypto.pad, r) n.JsCrypto = n.JsCrypto || {}, n.JsCrypto.pad[e] = r[e];
            }
          }(this, function () {
            return function () {
              "use strict";
              ...
              var a = function () {
                ...
                return Object.defineProperty(n.prototype, "nSigBytes", {
                  ...
                  for (var r = [], e = 0; e < t; e += 4) r.push(a());
              ...
              var f = {
                pad: function (n, t) {
                  for (var r = 4 * t, e = r - n.nSigBytes % r, i = e << 24 | e << 16 | e << 8 | e, o = [], a = 0; a < e; a += 4) o.push(i);

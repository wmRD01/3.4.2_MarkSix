System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  function CBCMAC(plainText, associatedData, key, iv, tagLength, props) {
    ...
    const K = typeof key === "string" ? (_crd && Utf8 === void 0 ? (_reportPossibleCrUseOfUtf({
      error: Error()
    }), Utf8) : Utf8).parse(key) : key;
    const N = iv ? iv : new (_crd && Word32Array === void 0 ? (_reportPossibleCrUseOfWord32Array({
      error: Error()
    }), Word32Array) : Word32Array)([0, 0]);
    const A = typeof associatedData === "string" ? (_crd && Utf8 === void 0 ? (_reportPossibleCrUseOfUtf({
      error: Error()
    }), Utf8) : Utf8).parse(associatedData) : associatedData;
    const P = typeof plainText === "string" ? (_crd && Utf8 === void 0 ? (_reportPossibleCrUseOfUtf({
      error: Error()

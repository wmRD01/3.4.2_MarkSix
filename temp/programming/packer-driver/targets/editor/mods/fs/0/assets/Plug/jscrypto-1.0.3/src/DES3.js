    ...
    execute: function () {
      ...
      _export("DES3", DES3 = class DES3 extends (_crd && BlockCipher === void 0 ? (_reportPossibleCrUseOfBlockCipher({
        ...
        constructor(props) {
          ...
          const TripleDES = this._get3DES(); // Create DES instances
        ...
        _get3DES() {
          ...
          const des1 = (_crd && DES === void 0 ? (_reportPossibleCrUseOfDES({
            error: Error()
          }), DES) : DES).createEncryptor(new (_crd && Word32Array === void 0 ? (_reportPossibleCrUseOfWord32Array({
            error: Error()
          }), Word32Array) : Word32Array)(key1));
          const des2 = (_crd && DES === void 0 ? (_reportPossibleCrUseOfDES({
            error: Error()
          }), DES) : DES).createEncryptor(new (_crd && Word32Array === void 0 ? (_reportPossibleCrUseOfWord32Array({
            error: Error()
          }), Word32Array) : Word32Array)(key2));
          const des3 = (_crd && DES === void 0 ? (_reportPossibleCrUseOfDES({
            error: Error()
          }), DES) : DES).createEncryptor(new (_crd && Word32Array === void 0 ? (_reportPossibleCrUseOfWord32Array({
            error: Error()

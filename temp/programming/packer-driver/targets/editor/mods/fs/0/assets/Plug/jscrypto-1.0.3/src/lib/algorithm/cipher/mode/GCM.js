    ...
    execute: function () {
      ...
      _export("GCM", GCM = class GCM extends (_crd && BlockCipherMode === void 0 ? (_reportPossibleCrUseOfBlockCipherMode({
        ...
        static GCTR(cipher, ICB, X) {
          ...
          const Y = new (_crd && Word32Array === void 0 ? (_reportPossibleCrUseOfWord32Array({
            error: Error()
          ...
          for (let i = 0; i < n; i++) {
            ...
            remainderOf16Bytes === 0) {
              ...
              const Yi = new (_crd && Word32Array === void 0 ? (_reportPossibleCrUseOfWord32Array({
                error: Error()
            ...
            const Yn = new (_crd && Word32Array === void 0 ? (_reportPossibleCrUseOfWord32Array({
              error: Error()
        ...
        static mac(Cipher, key, iv, aad, cipherText, tagLength) {
          ...
          const A = (aad === null || aad === void 0 ? void 0 : aad.clone()) || new (_crd && Word32Array === void 0 ? (_reportPossibleCrUseOfWord32Array({
            error: Error()
          }), Word32Array) : Word32Array)();
          const lenA = [0, A.nSigBytes * 8];
          const C = (cipherText === null || cipherText === void 0 ? void 0 : cipherText.clone()) || new (_crd && Word32Array === void 0 ? (_reportPossibleCrUseOfWord32Array({
            error: Error()
          }), Word32Array) : Word32Array)();
          const lenC = [0, C.nSigBytes * 8];
          const lenT = tagLength || 16; // Pad
          ...
          const MAC = GCM.GCTR(cipher, J0, new (_crd && Word32Array === void 0 ? (_reportPossibleCrUseOfWord32Array({
            error: Error()
      ...
      _defineProperty(GCM, "Encryptor", class Encryptor extends GCM {
        ...
        processBlock(words, offset) {
          ...
          const blockSize = cipher.blockSize; // Encrypt with CTR mode

          this._CB = GCM.inc32(this._CB);
          const plainText = new (_crd && Word32Array === void 0 ? (_reportPossibleCrUseOfWord32Array({
            error: Error()
      ...
      _defineProperty(GCM, "Decryptor", class Decryptor extends GCM {
        ...
        processBlock(words, offset) {
          // Shortcuts
          const cipher = this._cipher;
          const blockSize = cipher.blockSize; // Decrypt with CTR mode

          this._CB = GCM.inc32(this._CB);
          const C = new (_crd && Word32Array === void 0 ? (_reportPossibleCrUseOfWord32Array({
            error: Error()
          }), Word32Array) : Word32Array)(words.slice(offset, offset + blockSize));

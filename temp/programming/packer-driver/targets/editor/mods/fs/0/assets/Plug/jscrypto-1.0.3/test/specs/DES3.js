        ...
        (function () {
          ...
          describe("des3", function () {
            ...
            it("test multi part", function () {
              const expectedResult = DES3.encrypt(Hex.parse("00112233445566778899aabbccddeeff"), Hex.parse("000102030405060708090a0b0c0d0e0f1011121314151617"), {
                mode: ECB,
                padding: NoPadding
              }).cipherText.toString();
            ...
            it("test 64bit key", function () {
              ...
              const output1 = DES3.encrypt(message, key, {
                mode: ECB
              }).toString();
              const output2 = DES3.encrypt(message, extendedKey, {
                mode: ECB
              }).toString();
            ...
            it("test 256bit key", function () {
              ...
              const output2 = DES3.encrypt(message, truncatedKey, {
                mode: ECB
              }).toString();
              expect(output2).to.be(output1);
            });

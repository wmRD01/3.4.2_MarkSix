System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, Button, Color, color, Sprite, _decorator, LobbyStateEvent, BaseComponent, _dec, _dec2, _class, _class2, _descriptor, _temp, _crd, ccclass, property, PaenlFunctionButton;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", PaenlFunctionButton = (_dec = ccclass('PaenlFunctionButton'), _dec2 = property(Button), _dec(_class = (_class2 = (_temp = class PaenlFunctionButton extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        changeButtonState(isbool) {
          ...
          for (let index = 0; index < this.buttons.length; index++) {
            ...
            if (!isbool) this.buttons[index].getComponent(Sprite).color = color().fromHEX("#818181");else this.buttons[index].getComponent(Sprite).color = Color.WHITE;
          }
        }

      ...
      _export("default", PanelExchange = (_dec = ccclass('PanelExchange'), _dec(_class = class PanelExchange extends (_crd && DataExchange === void 0 ? (_reportPossibleCrUseOfDataExchange({
        ...
        onLoad() {
          ...
          for (let index = 0; index < this.contentBntton.children.length; index++) {
            let btn = new (_crd && PointBtn === void 0 ? (_reportPossibleCrUseOfPointBtn({
              error: Error()
        ...
        onAddPoint(e, customEventData) {
          let getNum = Number((_crd && GameData === void 0 ? (_reportPossibleCrUseOfGameData({
            error: Error()
          ...
          let editWrite = Number((_crd && PublicModel === void 0 ? (_reportPossibleCrUseOfPublicModel({
            error: Error()
          ...
          let count = (_crd && MyMath === void 0 ? (_reportPossibleCrUseOfMyMath({
            error: Error()
        ...
        onExChagne(e, customEventData) {
          let _excc = new (_crd && excc === void 0 ? (_reportPossibleCrUseOfexcc({
            error: Error()
          }), excc) : excc)();
        ...
        refreshEditBoxState(change) {
          ...
          for (let index = 0; index < this.arrayPointButton.length; index++) {
            let convertNumber = Number((_crd && GameData === void 0 ? (_reportPossibleCrUseOfGameData({
              error: Error()
        ...
        onEditBoxEditing(e, customEventData) {
          ...
          let getNum = Number((_crd && PublicModel === void 0 ? (_reportPossibleCrUseOfPublicModel({
            error: Error()

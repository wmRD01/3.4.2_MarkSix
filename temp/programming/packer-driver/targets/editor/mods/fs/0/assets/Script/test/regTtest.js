System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, extentTest, _dec, _class, _crd, ccclass, property, regTtest;

  function _reportPossibleCrUseOfextentTest(extras) {
    _reporterNs.report("extentTest", "./extentTest", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      extentTest = _unresolved_2.default;
    }],
    execute: function () {
      _crd = true;

      _cclegacy._RF.push({}, "da26cCKPGVJsbCVo8AM+cde", "regTtest", undefined);
      ...
      _export("default", // 插件(Xregexp)(未使用)
      ...
      regTtest = (_dec = ccclass('regTtest'), _dec(_class = class regTtest extends (_crd && extentTest === void 0 ? (_reportPossibleCrUseOfextentTest({
        error: Error()
        ...
        onLoad() {
          ...
          if (/\p{Alphabetic}/u.test(str) && /\p{Number}/u.test(str)) console.log("包含英數");
          ...
          let rex = /[\p{P}+\u2100-\u214F]/u;
          console.log(rex.test(spesil)); // console.log(/\p{Special}/u.test(str));
...
//# sourceMappingURL=regTtest.js.map
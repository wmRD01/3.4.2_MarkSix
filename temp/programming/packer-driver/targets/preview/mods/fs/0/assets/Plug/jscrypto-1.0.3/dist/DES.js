            ...
            return function () {
              ...
              var n = {
                ...
                1868: function _(n, t, r) {
                  ...
                  var _i2,
                    ...
                    return o(t, n), Object.defineProperty(t.prototype, "blockSize", {
                      ...
                      return this.R(n), this.S(), this;
                    }, t.prototype.finalize = function (n) {
                      return n && this.R(n), this.N();
                ...
                787: function _(n, t, r) {
                  ...
                  var _i3,
                    ...
                    function t(t) {
                      var r = n.call(this, t) || this;
                      return r.U = 4, r.q = o.n, r.J = u.l, r.j = t, r.q = void 0 !== t.mode ? t.mode : r.q, r.J = void 0 !== t.padding ? t.padding : r.J, r.reset(null == t ? void 0 : t.data, null == t ? void 0 : t.nBytes), r;
                    }
                    ...
                    return f(t, n), Object.defineProperty(t.prototype, "mode", {
                      ...
                      var i;
                      n.prototype.reset.call(this, t, r), this.L === e.t.ENC_TRANSFORM_MODE ? i = this.q.createEncryptor : (i = this.q.createDecryptor, this.B = 1), this.q && this.V === i ? this.K = new this.q({
                        cipher: this,
                        iv: this.X
                      }) : (this.K = i.call(this.q, {
                        cipher: this,
                        iv: this.X
                      }), this.V = i);
                    }, t.prototype.A = function (n, t) {
                      var r;
                      null === (r = this.K) || void 0 === r || r.processBlock(n, t);
                    }, t.prototype.N = function () {
                      var n,
                          t = this.J;
              ...
              return function () {
                ...
                var _n,
                  ...
                  function t(t) {
                    var r = n.call(this, t) || this;
                    return r.U = 2, r.on = [], r.un = [], r.fn = 0, r.cn = 0, r.j = t, r.O(), r;
                  }

                  return f(t, n), t.prototype.O = function () {
                    for (var n = this.Y.words, t = [], r = 0; r < 56; r++) {
                      var i = s[r] - 1;
                      t[r] = n[i >>> 5] >>> 31 - i % 32 & 1;
                    }

                    for (var e = this.on = [], o = 0; o < 16; o++) {
                      var u = e[o] = [],
                          f = h[o];

                      for (r = 0; r < 24; r++) {
                        u[r / 6 | 0] |= t[(a[r] - 1 + f) % 28] << 31 - r % 6, u[4 + (r / 6 | 0)] |= t[28 + (a[r + 24] - 1 + f) % 28] << 31 - r % 6;
                      }
                    ...
                    this.sn(n, t, this.un);
                  }, t.prototype.sn = function (n, t, r) {
                    this.fn = n[t], this.cn = n[t + 1], this.an(4, 252645135), this.an(16, 65535), this.hn(2, 858993459), this.hn(8, 16711935), this.an(1, 1431655765);

                    for (var i = 0; i < 16; i++) {
                      for (var e = r[i], o = this.fn, u = this.cn, f = 0, c = 0; c < 8; c++) {
                        var s = (u ^ e[c]) & w[c];
                        f |= v[c][s >>> 0];
                      }

                      this.fn = u, this.cn = o ^ f;
                    }

                    var a = this.fn;
                    this.fn = this.cn, this.cn = a, this.an(1, 1431655765), this.hn(8, 16711935), this.hn(2, 858993459), this.an(16, 65535), this.an(4, 252645135), n[t] = this.fn, n[t + 1] = this.cn;
                  }, t.prototype.an = function (n, t) {
                    var r = (this.fn >>> n ^ this.cn) & t;
                    this.cn ^= r, this.fn ^= r << n;
                  }, t.prototype.hn = function (n, t) {
                    var r = (this.cn >>> n ^ this.fn) & t;
                    this.fn ^= r, this.cn ^= r << n;
                  }, t.createEncryptor = function (n, r) {

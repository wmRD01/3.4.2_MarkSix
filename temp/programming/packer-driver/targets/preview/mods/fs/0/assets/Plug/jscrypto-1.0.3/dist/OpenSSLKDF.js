          ...
          !function (n, t) {
            ...
            return function () {
                ...
                3354: function _(n, t, r) {
                  ...
                  var i = r(5720),
                    ...
                    return Object.defineProperty(n.prototype, "nSigBytes", {
                      ...
                      for (var n = this.U, t = this.N, r = new Uint8Array(t), i = 0; i < t; i++) {
              ...
              return function () {
                ...
                for (var n = r(3354), t = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", e = [], o = 0; o < t.length; o++) {
                  e[t.charCodeAt(o)] = o;
                }
                ...
                var _u,
                  ...
                  stringify: function stringify(n) {
                    ...
                    for (var e = [], o = 0; o < i; o += 3) {
                      for (var u = (r[o >>> 2] >>> 24 - o % 4 * 8 & 255) << 16 | (r[o + 1 >>> 2] >>> 24 - (o + 1) % 4 * 8 & 255) << 8 | r[o + 2 >>> 2] >>> 24 - (o + 2) % 4 * 8 & 255, f = 0; f < 4 && o + .75 * f < i; f++) {
                        e.push(t.charAt(u >>> 6 * (3 - f) & 63));
                      }
                    }
                  ...
                  _u(n, t), n.prototype = null === t ? Object.create(t) : (r.prototype = t.prototype, new r());
                }),
                    d = function (t) {
                  function r(n) {
                  ...
                  return (_l = Object.assign || function (n) {
                    ...
                    y = {
                  execute: function execute(t, r, i, e, o) {
                    e || (e = n.e.random(8));

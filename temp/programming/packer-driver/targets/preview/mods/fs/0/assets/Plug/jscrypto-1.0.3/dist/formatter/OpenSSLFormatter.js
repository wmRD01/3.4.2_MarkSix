        ...
        (function () {
          !function (t, r) {
            if ("object" == typeof exports && "object" == typeof module) module.exports = r();else if ("function" == typeof define && define.amd) define([], r);else if ("object" == typeof exports) exports.JsCrypto = r();else {
              ...
              for (var e in t.JsCrypto = t.JsCrypto || {}, t.JsCrypto.formatter = t.JsCrypto = t.JsCrypto || {}, t.JsCrypto.formatter, n) {
                t.JsCrypto = t.JsCrypto || {}, t.JsCrypto.formatter[e] = n[e];
              }
            }
          }(this, function () {
            return function () {
              ...
              var r = {};
              t.r(r), t.d(r, {
                OpenSSLFormatter: function OpenSSLFormatter() {
                  return y;
                }
              });
              ...
              for (var a = function () {
                ...
                function t(r, n) {
                  ...
                  for (var i = e.byteLength, o = [], f = 0; f < i; f++) {
                    o[f >>> 2] |= e[f] << 24 - f % 4 * 8;
                  }
                ...
                return Object.defineProperty(t.prototype, "nSigBytes", {
                  ...
                  for (var t = this.i, r = this.u, n = new Uint8Array(r), e = 0; e < r; e++) {
                    n[e] = t[e >>> 2] >>> 24 - e % 4 * 8 & 255;
                  }
                  ...
                  for (var n = [], e = 0; e < r; e += 4) {
                    n.push(a());
                  }

                  return new t(n, r);
                }, t;
              }(), s = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", c = [], h = 0; h < s.length; h++) {
                c[s.charCodeAt(h)] = h;
              }
              ...
              var v = {
                stringify: function stringify(t) {
                  ...
                  for (var e = [], i = 0; i < n; i += 3) {
                    for (var o = (r[i >>> 2] >>> 24 - i % 4 * 8 & 255) << 16 | (r[i + 1 >>> 2] >>> 24 - (i + 1) % 4 * 8 & 255) << 8 | r[i + 2 >>> 2] >>> 24 - (i + 2) % 4 * 8 & 255, f = 0; f < 4 && i + .75 * f < n; f++) {
                      e.push(s.charAt(o >>> 6 * (3 - f) & 63));
                    }
                  }

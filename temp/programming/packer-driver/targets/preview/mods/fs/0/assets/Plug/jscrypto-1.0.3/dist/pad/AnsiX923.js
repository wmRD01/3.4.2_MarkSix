        ...
        (function () {
          !function (e, n) {
            if ("object" == typeof exports && "object" == typeof module) module.exports = n();else if ("function" == typeof define && define.amd) define([], n);else if ("object" == typeof exports) exports.JsCrypto = n();else {
              ...
              for (var o in e.JsCrypto = e.JsCrypto || {}, e.JsCrypto.pad = e.JsCrypto = e.JsCrypto || {}, e.JsCrypto.pad, t) {
                e.JsCrypto = e.JsCrypto || {}, e.JsCrypto.pad[o] = t[o];
              }
            }
          }(this, function () {
            return function () {
              ...
              var t = {
                pad: function pad(e, n) {
                  var t = e.nSigBytes,
                      ...
                      f = o - t % o,
                      u = t + f - 1;
                  e.clamp(), e.words[u >>> 2] |= f << 24 - u % 4 * 8, e.nSigBytes += f;
                },
                unpad: function unpad(e) {
                  var n = 255 & e.words[e.nSigBytes - 1 >>> 2];
                  e.nSigBytes -= n;
                }
              };
              return n;

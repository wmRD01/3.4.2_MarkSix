        ...
        (function () {
          !function (e, n) {
            if ("object" == typeof exports && "object" == typeof module) module.exports = n();else if ("function" == typeof define && define.amd) define([], n);else if ("object" == typeof exports) exports.JsCrypto = n();else {
              ...
              for (var t in e.JsCrypto = e.JsCrypto || {}, e.JsCrypto.pad = e.JsCrypto = e.JsCrypto || {}, e.JsCrypto.pad, o) {
                e.JsCrypto = e.JsCrypto || {}, e.JsCrypto.pad[t] = o[t];
              }
            }
          }(this, function () {
            return function () {
              ...
              var o = {
                ...
                unpad: function unpad(e) {
                  for (var n = e.words, o = e.nSigBytes - 1; o >= 0; o--) {

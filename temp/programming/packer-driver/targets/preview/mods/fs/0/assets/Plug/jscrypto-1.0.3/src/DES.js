System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, BlockCipher, Cipher, PasswordBasedCipher, SerializableCipher, DES, _crd, PC1, PC2, BIT_SHIFTS, SBOX_P, SBOX_MASK;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "7dad6ZuFHhIKIrOen7Aysx0", "DES", undefined);
      ...
      _export("DES", DES = class DES extends (_crd && BlockCipher === void 0 ? (_reportPossibleCrUseOfBlockCipher({
        error: Error()
        ...
        constructor(props) {
          ...
          _defineProperty(this, "_subKeys", []);

          _defineProperty(this, "_invSubKeys", []);

          _defineProperty(this, "_lBlock", 0);

          _defineProperty(this, "_rBlock", 0);
        ...
        _doReset() {
          ...
          for (var nSubKey = 0; nSubKey < 16; nSubKey++) {
            ...
            for (var _i2 = 1; _i2 < 7; _i2++) {
              subKey[_i2] = subKey[_i2] >>> (_i2 - 1) * 4 + 3;
            }
          ...
          for (var _i3 = 0; _i3 < 16; _i3++) {
            this._invSubKeys[_i3] = subKeys[15 - _i3];
          }
        }
        ...
        _doCryptoBlock(words, offset, subKeys) {
          ...
          this._rBlock = words[offset + 1]; // Initial permutation
          ...
          this._exchangeLR(1, 0x55555555); // Rounds
          ...
          for (var round = 0; round < 16; round++) {
            ...
            for (var i = 0; i < 8; i++) {
              var s = (rBlock ^ subKey[i]) & SBOX_MASK[i];
              f |= SBOX_P[i][s >>> 0];
            }
          ...
          this._exchangeLR(4, 0x0f0f0f0f); // Set output
        ...
        static encrypt(message, key, props) {
          if (typeof key === "string") {
            return (_crd && PasswordBasedCipher === void 0 ? (_reportPossibleCrUseOfPasswordBasedCipher({
              error: Error()
            }), PasswordBasedCipher) : PasswordBasedCipher).encrypt(DES, message, key, props);
          }

          return (_crd && SerializableCipher === void 0 ? (_reportPossibleCrUseOfSerializableCipher({
            error: Error()
          }), SerializableCipher) : SerializableCipher).encrypt(DES, message, key, props);
        }
        /**
        ...
        static decrypt(cipherText, key, props) {
          if (typeof key === "string") {
            return (_crd && PasswordBasedCipher === void 0 ? (_reportPossibleCrUseOfPasswordBasedCipher({
              error: Error()
            }), PasswordBasedCipher) : PasswordBasedCipher).decrypt(DES, cipherText, key, props);
          }

          return (_crd && SerializableCipher === void 0 ? (_reportPossibleCrUseOfSerializableCipher({
            error: Error()
          }), SerializableCipher) : SerializableCipher).decrypt(DES, cipherText, key, props);
        }

      });

      _defineProperty(DES, "keySize", 64 / 32);

      _defineProperty(DES, "ivSize", 64 / 32);

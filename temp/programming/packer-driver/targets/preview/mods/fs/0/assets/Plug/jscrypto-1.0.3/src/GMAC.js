System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  function GMAC(message, key, iv, tagLength, props) {
    var aad = typeof message === "string" ? (_crd && Utf8 === void 0 ? (_reportPossibleCrUseOfUtf({
      error: Error()
    }), Utf8) : Utf8).parse(message) : message;
    var initializingVector = iv ? iv : new (_crd && Word32Array === void 0 ? (_reportPossibleCrUseOfWord32Array({
      error: Error()
    }), Word32Array) : Word32Array)([0, 0, 0, 0]);
    var Cipher = props && props.Cipher ? props.Cipher : _crd && AES === void 0 ? (_reportPossibleCrUseOfAES({
      error: Error()
    }), AES) : AES;
    var wKey = typeof key === "string" ? (_crd && Utf8 === void 0 ? (_reportPossibleCrUseOfUtf({
      error: Error()

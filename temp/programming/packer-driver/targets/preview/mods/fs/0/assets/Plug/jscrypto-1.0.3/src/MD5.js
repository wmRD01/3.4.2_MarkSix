System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, Word32Array, Hasher, MD5, _crd, T;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "e0fbcMHdxZLKL7pqo9hIU61", "MD5", undefined);
      ...
      _export("MD5", MD5 = class MD5 extends (_crd && Hasher === void 0 ? (_reportPossibleCrUseOfHasher({
        error: Error()
      }), Hasher) : Hasher) {
        constructor(props) {
          super(props);
          ...
          _defineProperty(this, "_hash", new (_crd && Word32Array === void 0 ? (_reportPossibleCrUseOfWord32Array({
            error: Error()
          }), Word32Array) : Word32Array)([0x67452301, 0xefcdab89, 0x98badcfe, 0x10325476]));
        ...
        _doProcessBlock(words, offset) {
          ...
          for (var i = 0; i < 16; i++) {
            ...
            var wordsOffsetI = words[offsetI];
            words[offsetI] = (wordsOffsetI << 8 | wordsOffsetI >>> 24) & 0x00ff00ff | (wordsOffsetI << 24 | wordsOffsetI >>> 8) & 0xff00ff00;
          } // Shortcuts


          var H = this._hash.words;
          var wordOffset0 = words[offset];
          var wordOffset1 = words[offset + 1];
          var wordOffset2 = words[offset + 2];
          var wordOffset3 = words[offset + 3];
          var wordOffset4 = words[offset + 4];
          var wordOffset5 = words[offset + 5];
          var wordOffset6 = words[offset + 6];
          var wordOffset7 = words[offset + 7];
          var wordOffset8 = words[offset + 8];
          var wordOffset9 = words[offset + 9];
          var wordOffset10 = words[offset + 10];
          var wordOffset11 = words[offset + 11];
          var wordOffset12 = words[offset + 12];
          var wordOffset13 = words[offset + 13];
          var wordOffset14 = words[offset + 14];
          var wordOffset15 = words[offset + 15]; // Working variables
          ...
          b = II(b, c, d, a, wordOffset9, 21, T[63]); // Intermediate hash value

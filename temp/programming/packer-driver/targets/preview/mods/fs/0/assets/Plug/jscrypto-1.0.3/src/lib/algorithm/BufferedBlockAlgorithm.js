  ...
  return {
    ...
    execute: function () {
      ...
      _export("BufferedBlockAlgorithm", BufferedBlockAlgorithm = class BufferedBlockAlgorithm {
        ...
        _append(data) {
          var d = typeof data === "string" ? (_crd && Utf8 === void 0 ? (_reportPossibleCrUseOfUtf({
            error: Error()
        ...
        _process(doFlush) {
          var processedWords;
          var words = this._data.words;
          var nSigBytes = this._data.nSigBytes;
          var blockSize = this._blockSize;
          var blockSizeByte = this._blockSize * 4;
          var nBlocksReady = nSigBytes / blockSizeByte;
          ...
          var nBytesReady = Math.min(nWordsReady * 4, nSigBytes); // Process blocks

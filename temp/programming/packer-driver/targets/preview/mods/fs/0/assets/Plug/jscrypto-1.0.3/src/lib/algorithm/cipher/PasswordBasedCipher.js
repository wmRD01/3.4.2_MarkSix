    ...
    execute: function () {
      ...
      _export("PasswordBasedCipher", PasswordBasedCipher = {
        ...
        encrypt(Cipher, message, password, props) {
          var cipherProps = props ? _extends({}, props) : {};
          var KDF = props && props.KDF ? props.KDF : _crd && OpenSSLKDF === void 0 ? (_reportPossibleCrUseOfOpenSSLKDF({
            error: Error()
          ...
          var derivedParams = KDF.execute(password, Cipher.keySize, Cipher.ivSize, cipherProps.kdfSalt, kdfProps);
          cipherProps.iv = derivedParams.iv;
          var cipherParams = (_crd && SerializableCipher === void 0 ? (_reportPossibleCrUseOfSerializableCipher({
            error: Error()
          ...
          return new (_crd && CipherParams === void 0 ? (_reportPossibleCrUseOfCipherParams({
            error: Error()
          }), CipherParams) : CipherParams)(_extends({}, cipherParams, {
        ...
        decrypt(Cipher, cipherParams, password, props) {
          var p = props ? _extends({}, props) : {};
          var KDF = p.KDF ? p.KDF : _crd && OpenSSLKDF === void 0 ? (_reportPossibleCrUseOfOpenSSLKDF({
            error: Error()
          }), OpenSSLKDF) : OpenSSLKDF;
          var formatter = p.formatter ? p.formatter : _crd && OpenSSLFormatter === void 0 ? (_reportPossibleCrUseOfOpenSSLFormatter({
            error: Error()
          }), OpenSSLFormatter) : OpenSSLFormatter;
          var cipherParamsObj = (_crd && parseCipherText === void 0 ? (_reportPossibleCrUseOfparseCipherText({
            error: Error()
          ...
          var derivedParams = KDF.execute(password, Cipher.keySize, Cipher.ivSize, cipherParamsObj.salt, kdfProps);

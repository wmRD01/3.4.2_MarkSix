    ...
    execute: function () {
      ...
      _export("SerializableCipher", SerializableCipher = {
        ...
        encrypt(Cipher, message, key, props) {
          var encryptor = Cipher.createEncryptor(key, props);
        ...
        decrypt(Cipher, cipherParams, key, props) {
          var decryptor = Cipher.createDecryptor(key, props);
          var cipherParamsObj = parseCipherText(cipherParams, (props === null || props === void 0 ? void 0 : props.formatter) || (_crd && OpenSSLFormatter === void 0 ? (_reportPossibleCrUseOfOpenSSLFormatter({
            error: Error()
          }), OpenSSLFormatter) : OpenSSLFormatter));

    ...
    execute: function () {
      ...
      _export("OpenSSLKDF", OpenSSLKDF = {
        execute(password, keySize, ivSize, salt, props) {
          ...
          var KDFModule = props && props.kdfModule || (_crd && PBKDF2 === void 0 ? (_reportPossibleCrUseOfPBKDF({
            error: Error()
          }), PBKDF2) : PBKDF2);
          var kdfProps = props ? {
          ...
          var key = KDFModule.getKey(password, salt, _extends({}, kdfProps, {
            keySize: keySize + ivSize
          })); // Separate key and IV

          var iv = new (_crd && Word32Array === void 0 ? (_reportPossibleCrUseOfWord32Array({
            error: Error()

System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  function pad(data, blockSize) {
    ...
    var nPaddingBytes = blockSizeBytes - data.nSigBytes % blockSizeBytes; // Create padding word
    ...
    var padding = new (_crd && Word32Array === void 0 ? (_reportPossibleCrUseOfWord32Array({
      error: Error()
  ...
  function unpad(data) {
    ...
    var nPaddingBytes = data.words[data.nSigBytes - 1 >>> 2] & 0xff; // Remove padding

        ...
        (function () {
          ...
          describe("hmac-sha224", function () {
            it("digest 'Hi There' as expected", function () {
              var expectedResult = "4e841ce7a4ae83fbcf71e3cd64bfbf277f73a14680aae8c518ac7861";
            ...
            it("digest 'what do ya want for nothing?' with 'Jefe' as expected", function () {
              var expectedResult = "a30e01098bc6dbbf45690f3a7e9e6d0f8bbea2a39e6148008fd05e44";
              var message = "what do ya want for nothing?";
              var key = "Jefe";
              expect(HmacSHA224(message, key).toString()).to.be(expectedResult);
            });
            it("digest long message and key as expected", function () {
              var expectedResult = "cbff7c2716bbaa7c77bed4f491d3e8456cb6c574e92f672b291acf5b";
            ...
            it("digest 'ABCDEFGHIJKLMNOPQRSTUVWXYZ' with 'A' as expected", function () {
              var expectedResult = "61bf669da4fdcd8e5c3bd09ebbb4a986d3d1b298d3ca05c511f7aeff";
              var message = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
              var key = "A";
              expect(HmacSHA224(message, key).toString()).to.be(expectedResult);
            });
            it("digest 'abcdefghijklmnopqrstuvwxyz' with 'A' as expected", function () {
              var expectedResult = "16fc69ada3c3edc1fe9144d6b98d93393833ae442bedf681110a1176";
              var message = "abcdefghijklmnopqrstuvwxyz";
              var key = "A";
              expect(HmacSHA224(message, key).toString()).to.be(expectedResult);
            });
            it("update", function () {
              var hmac = new Hmac(new SHA224(), Hex.parse("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"));

System.register(["path", "terser-webpack-plugin", "fork-ts-checker-webpack-plugin", "__unresolved_0"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_path) {
      ...
      _req2 = _terserWebpackPlugin.__cjsMetaURL;
    }, function (_forkTsCheckerWebpackPlugin) {
      _req3 = _forkTsCheckerWebpackPlugin.__cjsMetaURL;
    ...
    execute: function () {
      _loader.define(_context.meta.url, function (exports, _require, module, __filename, __dirname) {
        var require = _loader.createRequireWithReqMap({
          "path": _req,
          "terser-webpack-plugin": _req2,
          "fork-ts-checker-webpack-plugin": _req3
        }, _require);

        (function () {
          var path = require("path"); // const {CleanWebpackPlugin} = require("clean-webpack-plugin");
              ...
              module: {
                rules: [{
                  ...
                  use: [{
                    ...
                    options: {
                      transpileOnly: true,
                      configFile: isProd ? "tsconfig.es5.json" : "tsconfig.json"
                    }
                  }],

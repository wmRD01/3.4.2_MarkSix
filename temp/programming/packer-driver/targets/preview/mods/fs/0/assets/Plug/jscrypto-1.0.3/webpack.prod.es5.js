    ...
    execute: function () {
      _loader.define(_context.meta.url, function (exports, _require, module, __filename, __dirname) {
        ...
        (function () {
          ...
          module.exports = [_extends({}, baseConfig("production"), {
            entry: _extends({}, mainEntry()),
            output: _extends({}, mainOutput("production"))
          }), _extends({}, baseConfig("production"), {
            entry: _extends({}, modeModuleEntry()),
            output: _extends({}, modeModuleOutput("production"))
          }), _extends({}, baseConfig("production"), {
            entry: _extends({}, padModuleEntry()),
            output: _extends({}, padModuleOutput("production"))
          }), _extends({}, baseConfig("production"), {
            entry: _extends({}, formatterModuleEntry()),
            output: _extends({}, formatterModuleOutput("production"))
          })];
        })();

      ...
      _export("default", PanelTextAnimation = (_dec = ccclass('PanelTextAnimation'), _dec2 = property(_crd && TextData === void 0 ? (_reportPossibleCrUseOfTextData({
        ...
        startAction(callback) {
          ...
          var _loop = function _loop(index) {
            var initX = _this.content.children[index].position.x + 50;
            _this.content.children[index].getComponent(UIOpacity).opacity = 0;
            tween(_this.content.children[index]).set({
              position: v3(initX, 0)
              ...
              if (index == _this.content.children.length - 1 && callback) _this.fadeOut(_this.node, callback);else _this.fadeOut(_this.node);
            }).start();
            timeindex++;
          };
        ...
        chooseBG() {
          ...
          var spriteStr = this.getText == (_crd && TextAnimationType === void 0 ? (_reportPossibleCrUseOfTextAnimationType({
            error: Error()
        ...
        AddSpacing() {
          var tempSpacing = this.defaultSpacing;

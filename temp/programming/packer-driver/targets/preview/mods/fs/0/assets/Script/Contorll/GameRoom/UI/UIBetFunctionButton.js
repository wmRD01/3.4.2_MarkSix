  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", UIBetFunctionButton = (_dec = ccclass('UIBetFunctionButton'), _dec2 = property(Label), _dec3 = property(Button), _dec4 = property(Button), _dec(_class = (_class2 = (_temp = class UIBetFunctionButton extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        onBackBet() {
          var _gbbk = new (_crd && gbbk === void 0 ? (_reportPossibleCrUseOfgbbk({
            error: Error()
          }), gbbk) : gbbk)();
        ...
        onClearBet() {
          var _gbcl = new (_crd && gbcl === void 0 ? (_reportPossibleCrUseOfgbcl({
            error: Error()
          }), gbcl) : gbcl)();
        ...
        onReferLastBet() {
          var _gbrt = new (_crd && gbrt === void 0 ? (_reportPossibleCrUseOfgbrt({
            error: Error()
          }), gbrt) : gbrt)();

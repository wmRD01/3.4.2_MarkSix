System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "fc559QZtM5I2KqCGZlXtkhw", "PanelLogin", undefined);
      ...
      _export("default", PanelLogin = (_dec = ccclass('PanelLogin'), _dec(_class = (_temp = class PanelLogin extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        setLogo(_sprite) {
          var getUI = this.sprite_Logo.getComponent(UIOpacity);
          getUI.opacity = 255;
          this.sprite_Logo.spriteFrame = _sprite;
          var getOrg = this.sprite_Logo.node.position; // tween(getUI)
          //     .to(.5, { opacity: 255 })
          //     .start()
          // let action = tween()
...
//# sourceMappingURL=PanelLogin.js.map
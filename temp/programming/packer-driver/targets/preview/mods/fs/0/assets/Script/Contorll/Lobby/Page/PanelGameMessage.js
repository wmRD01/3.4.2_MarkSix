System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "5a750HU6JtC6bfql2XykySL", "PanelGameMessage", undefined);
      ...
      _export("default", PanelGameMessage = (_dec = ccclass('PanelGameMessage'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Node), _dec(_class2 = (_class3 = (_temp = class PanelGameMessage extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        onGameMessage(str) {
          ...
          var _class = _node.getComponent(_crd && MessageItem === void 0 ? (_reportPossibleCrUseOfMessageItem({
            error: Error()
          }), MessageItem) : MessageItem);

          if (this.spriteContent.children.length > 0) for (var index = 0; index < this.spriteContent.children.length; index++) {

System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, Label, Tween, _decorator, MyMath, GameEvent, GameStateEvent, BaseComponent, PublicModel, _dec, _dec2, _class, _class2, _descriptor, _temp, _crd, ccclass, property, PanelTimer;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "00af8Nl7yNG4J7ga/SqG8Va", "PanelTimer", undefined);
      ...
      _export("default", PanelTimer = (_dec = ccclass('PanelTimer'), _dec2 = property(Label), _dec(_class = (_class2 = (_temp = class PanelTimer extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        update(dt) {
          if (this.labelTime.node.active) {
            ...
            var convetTime = (_crd && PublicModel === void 0 ? (_reportPossibleCrUseOfPublicModel({
              error: Error()

System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, Label, Sprite, _decorator, AssetType, AssetMng, MusicMng, BaseComponent, PublicModel, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _temp, _crd, ccclass, property, SettingItem, Type, Active;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "99848xiR0NGs7tY8J47a2aH", "SettingItem", undefined);
      ...
      _export("default", SettingItem = (_dec = ccclass('SettingItem'), _dec2 = property(Sprite), _dec3 = property(Sprite), _dec4 = property(Label), _dec5 = property(Label), _dec(_class = (_class2 = (_temp = class SettingItem extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()

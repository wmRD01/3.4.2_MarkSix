System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, instantiate, Node, Prefab, Vec3, _decorator, BaseComponent, PointItemData, _dec, _dec2, _dec3, _class2, _class3, _descriptor, _descriptor2, _temp, _crd, ccclass, property, PanelClientPointRecord;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "7a747RhETFAubBONWDNGrux", "PanelClientPointRecord", undefined);
      ...
      _export("default", PanelClientPointRecord = (_dec = ccclass('PanelClientPointRecord'), _dec2 = property(Prefab), _dec3 = property(Node), _dec(_class2 = (_class3 = (_temp = class PanelClientPointRecord extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
...
//# sourceMappingURL=PanelClientPointRecord.js.map
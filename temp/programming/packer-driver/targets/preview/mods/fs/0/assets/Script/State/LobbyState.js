        ...
        changeState(data) {
          ...
          if ((_crd && GameData === void 0 ? (_reportPossibleCrUseOfGameData({
            ...
            director.preloadScene((_crd && GameSceneName === void 0 ? (_reportPossibleCrUseOfGameSceneName({
              ...
              var _lbsr = new (_crd && lbsr === void 0 ? (_reportPossibleCrUseOflbsr({
                error: Error()
              }), lbsr) : lbsr)();
      ...
      _export("InGame", InGame = class InGame extends (_crd && State === void 0 ? (_reportPossibleCrUseOfState({
        ...
        changeState(data) {
          if (data.code > 0) {
            ...
            var _data = new CreatorRoomData();

            _data.playMinute = 1;
            _data.roomName = Math.floor(random() * 100000).toString();
            _data.betMin = 10;
            _data.betMax = 10000;
            _data.betOptions = [10, 200, 500, 1000, 10000];
            _data.thinkSecond = 10;
            ...
            (_crd && EventMng === void 0 ? (_reportPossibleCrUseOfEventMng({
              ...
              error: Error()
            }), CommandType) : CommandType).vlcr, _data);
          } else {
            director.loadScene((_crd && GameSceneName === void 0 ? (_reportPossibleCrUseOfGameSceneName({
              error: Error()
            }), GameSceneName) : GameSceneName).GameRoom);

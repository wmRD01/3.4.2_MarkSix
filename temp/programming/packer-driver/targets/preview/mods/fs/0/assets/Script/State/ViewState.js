    ...
    execute: function () {
      ...
      _export("GetGameRoomData", GetGameRoomData = class GetGameRoomData extends (_crd && State === void 0 ? (_reportPossibleCrUseOfState({
        ...
        changeState(data) {
          ...
          var getbuffer = (_crd && PublicModel === void 0 ? (_reportPossibleCrUseOfPublicModel({
            error: Error()
          ...
          for (var index = 0; index < getbuffer.length; index++) {}
      ...
      _export("LobbyOpenView", LobbyOpenView = class LobbyOpenView extends (_crd && State === void 0 ? (_reportPossibleCrUseOfState({
        ...
        changeState(data) {// if (PublicData.getInstance.isSystemDis || !PublicData.getInstance.isInGameRoom) return;
          // console.log("載資料")

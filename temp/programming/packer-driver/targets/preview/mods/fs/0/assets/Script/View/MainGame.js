      ...
      _export("MainGame", MainGame = (_dec = ccclass('MainGame'), _dec2 = property(_crd && PanelClientCoin === void 0 ? (_reportPossibleCrUseOfPanelClientCoin({
        ...
        start() {
          ...
          return _asyncToGenerator(function* () {
            //建立連線
            _this.eventEmit((_crd && GameEvent === void 0 ? (_reportPossibleCrUseOfGameEvent({
              error: Error()
            }), GameEvent) : GameEvent).ResetView);

            yield (_crd && SocketSetting === void 0 ? (_reportPossibleCrUseOfSocketSetting({
              error: Error()
            ...
            for (var index = 0; index < (_crd && PublicData === void 0 ? (_reportPossibleCrUseOfPublicData({
              error: Error()
            ...
            if ((_crd && Player === void 0 ? (_reportPossibleCrUseOfPlayer({
              ...
              _this.panelClientCoin.hide();

              _this.panelUI.hide();

              (_crd && CanvasControll === void 0 ? (_reportPossibleCrUseOfCanvasControll({
                error: Error()
              }), CanvasControll) : CanvasControll).instance.node.on(Node.EventType.TOUCH_END, _this.eventPushNotificationGuset, _this);
            }
            ...
            yield (_crd && CheckLoading === void 0 ? (_reportPossibleCrUseOfCheckLoading({
              error: Error()
            }), CheckLoading) : CheckLoading).getInstance.checkAllEnd();

            _this.eventEmit((_crd && WebSocketEvent === void 0 ? (_reportPossibleCrUseOfWebSocketEvent({
              error: Error()
        ...
        onOwnerBet() {
          for (var index = 0; index < 30; index++) {
            var temp = new (_crd && gbet === void 0 ? (_reportPossibleCrUseOfgbet({
              error: Error()
            }), gbet) : gbet)();
            temp.chip = 100;
